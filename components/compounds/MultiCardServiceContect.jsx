...
const MultiCardServiceContent = (props) => {
    ...
    console.log(title)
    return (
        <div className="bg-white flex flex-col md:flex-row h-auto min-h-[280px] mb-[50px] p-3">
      ...
      <div className="absolute bottom-1 right-4 mb-8">
        ...
        />
            ...
            <div className="flex gap-5 flex-col xl:pt-[32px] pt-[32px] pl-[24px]  xl:pl-[32px] ">
                <div className="pb-[9px]  h-[56px]">
                    <Image src={iconPath} width={50} height={50} alt="image" className="" />
                </div>
