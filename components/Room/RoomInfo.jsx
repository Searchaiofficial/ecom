...

          {
            categoryDetails?.maintenanceDetails && categoryDetails?.certification && (
              ...
              <p className="font-medium ">
                ...
                <Link href={categoryDetails.maintenanceDetails} target="_blank" rel="noopener noreferrer" className="hover:underline hover:text-gray-900 font-semibold ">
                  Maintenance Details
                </Link>
                {' | '}
                <Link href={categoryDetails.certification} target="_blank" rel="noopener noreferrer" className="hover:underline hover:text-gray-900 font-semibold ">
