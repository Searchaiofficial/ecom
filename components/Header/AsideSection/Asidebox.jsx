    ...
    <>
      {asideCategory && (
        <div
          ...
          className="absolute top-[2.8rem] p-4 bg-white flex flex-col md:flex-row noto-sans-200 transition-all duration-300 ease-linear w-full md:left-0 h-lvh md:h-auto md:px-10"
        >
          <aside
