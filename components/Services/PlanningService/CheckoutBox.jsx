    ...
    return (
        <div className="flex flex-col justify-center items-start sm:items-center bg-gray-100 py-4 px-10 border border-white">
            <div className="flex justify-start sm:justify-center w-full">
                <img src={`${boxContent.icon}`} alt="" className="w-4 opacity-50" />
            </div>
            <h1 className="text-black text-lg font-semibold my-2 text-left sm:text-center">
                {boxContent.title}
            </h1>
            <h1 className="my-2 text-left sm:text-center">
