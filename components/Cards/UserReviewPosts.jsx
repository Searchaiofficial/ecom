            ...
            <div className={`mb-20 bg-white ${openModal ? 'overflow-hidden' : ''}`}>
                ...
                {openModal && (
                    <div className={`fixed top-0 z-[9999] overflow-y-auto right-0 w-[100%] lg:w-[70%] h-full bg-white shadow-lg transition-transform transform ${openModal ? "translate-x-0" : "translate-x-full"}`}>
                        ...
                        {selectedPost && (
                            <div className="lg:px-[32px] px-[24px] cursor-pointer flex">
                                ...
                                <div>
                                    {
                                        selectedPost.products.map((item) => (
                                            <Link href={`product/${item.productTitle}`} key={item._id}>
                                                <div className="flex pr-[20px] lg:pr-[0px] py-[30px] gap-5 items-center justify-between border-b">
                                                    <div>
                                                    ...
                                                    <div className="flex flex-col">
                                                        ...
                                                        <p className="text-[14px] text-[#484848]">Shelving unit with underframe, 147x94 cm</p>
